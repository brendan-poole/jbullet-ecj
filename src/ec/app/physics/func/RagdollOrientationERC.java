 ...
 * @version 1.0
 */
public class RagdollOrientationERC extends ERC {
    ...
    public void resetNode(final EvolutionState state, final int thread) {
        value = state.random[thread].nextDouble() * 44.0;
    }
    ...
    public String toStringForHumans() {
        return "O(" + (int) value % 11 + " "+(int) value / 11+")";
    }
    ...
    public void eval(final EvolutionState state,
        ...
        ((PhysicsProblem) problem).model.ragdolls.get(0).bodies[(int) (value % 11)].getOrientation(q);
        int i = (int) (value / 11);
        if (i == 0) {
            rd.x = q.w;
        } else if (i == 1) {
