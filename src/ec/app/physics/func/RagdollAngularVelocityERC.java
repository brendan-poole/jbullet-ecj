 ...
 * @version 1.0
 */
public class RagdollAngularVelocityERC extends ERC {
    ...
    public String toStringForHumans() {
        return "AV(" + (int) value % 11 + " "+(int) value / 11+")";
    }
    ...
    public void eval(final EvolutionState state,
        ...
        ((PhysicsProblem) problem).model.ragdolls.get(0).bodies[(int) (value % 11)].getAngularVelocity(v);
