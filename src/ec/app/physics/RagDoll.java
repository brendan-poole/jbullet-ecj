...
public RotationalLimitMotor[] motors;
	...
	public CollisionShape[] shapes = new CollisionShape[BodyPart.BODYPART_COUNT.ordinal()];
	public RigidBody[] bodies = new RigidBody[BodyPart.BODYPART_COUNT.ordinal()];
        public boolean[] bodyCollisions = new boolean[BodyPart.BODYPART_COUNT.ordinal()];
	public TypedConstraint[] joints = new TypedConstraint[JointType.JOINT_COUNT.ordinal()];
	...
	public RagDoll(DynamicsWorld ownerWorld, Vector3f positionOffset, float scale_ragdoll) {
                ...
                motors = new RotationalLimitMotor[30];
                for(int i=0;i<10;i++)
                    motors[i] = new RotationalLimitMotor();
		...
		/// ******* SPINE HEAD ******** ///
		{
			...
			joints[JointType.JOINT_SPINE_HEAD.ordinal()] = joint6DOF;
                        ...
                        motors[0] = joint6DOF.getRotationalLimitMotor(0);
                        motors[1] = joint6DOF.getRotationalLimitMotor(1);
                        motors[2] = joint6DOF.getRotationalLimitMotor(2);
		...
		/// ******* LEFT SHOULDER ******** ///
		{
			...
			//joint6DOF->setAngularUpperLimit(btVector3(SIMD_EPSILON,SIMD_EPSILON,SIMD_EPSILON));
			//#else
			tmp.set(-BulletGlobals.SIMD_PI * 0.8f, -BulletGlobals.SIMD_PI * 0.1f, -BulletGlobals.SIMD_PI * 0.5f);
			joint6DOF.setAngularLowerLimit(tmp);
			tmp.set(BulletGlobals.SIMD_PI * 0.8f, BulletGlobals.SIMD_PI *0.3f, BulletGlobals.SIMD_PI * 0.5f);
			joint6DOF.setAngularUpperLimit(tmp);
			//#endif
			joints[JointType.JOINT_LEFT_SHOULDER.ordinal()] = joint6DOF;

                        motors[3] = joint6DOF.getRotationalLimitMotor(0);
                        motors[4] = joint6DOF.getRotationalLimitMotor(1);
                        motors[5] = joint6DOF.getRotationalLimitMotor(2);
		...
		/// ******* RIGHT SHOULDER ******** ///
		{
			...
			joints[JointType.JOINT_RIGHT_SHOULDER.ordinal()] = joint6DOF;
                        ...
                        motors[6] = joint6DOF.getRotationalLimitMotor(0);
                        motors[7] = joint6DOF.getRotationalLimitMotor(1);
                        motors[8] = joint6DOF.getRotationalLimitMotor(2);
		...
		/// ******* LEFT ELBOW ******** ///
		{
			...
			joints[JointType.JOINT_LEFT_ELBOW.ordinal()] = joint6DOF;
                        ...
                        motors[9] = joint6DOF.getRotationalLimitMotor(0);
                        motors[10] = joint6DOF.getRotationalLimitMotor(1);
                        motors[11] = joint6DOF.getRotationalLimitMotor(2);
		...
		/// ******* RIGHT ELBOW ******** ///
		{
			...
			joints[JointType.JOINT_RIGHT_ELBOW.ordinal()] = joint6DOF;
                        ...
                        motors[12] = joint6DOF.getRotationalLimitMotor(0);
                        motors[13] = joint6DOF.getRotationalLimitMotor(1);
                        motors[14] = joint6DOF.getRotationalLimitMotor(2);
		...
		/// ******* PELVIS ******** ///
		{
			...
			joints[JointType.JOINT_PELVIS_SPINE.ordinal()] = joint6DOF;
                        ...
                        motors[15] = joint6DOF.getRotationalLimitMotor(0);
                        motors[16] = joint6DOF.getRotationalLimitMotor(1);
                        motors[17] = joint6DOF.getRotationalLimitMotor(2);
		...
		/// ******* LEFT HIP ******** ///
		{
			...
			//joint6DOF->setAngularUpperLimit(btVector3(SIMD_EPSILON,SIMD_EPSILON,SIMD_EPSILON));
			//#else
			tmp.set(-BulletGlobals.SIMD_HALF_PI, -BulletGlobals.SIMD_EPSILON, -BulletGlobals.SIMD_EPSILON);
			joint6DOF.setAngularLowerLimit(tmp);
			...
			joints[JointType.JOINT_LEFT_HIP.ordinal()] = joint6DOF;
                        ...
                        motors[18] = joint6DOF.getRotationalLimitMotor(0);
                        motors[19] = joint6DOF.getRotationalLimitMotor(1);
                        motors[20] = joint6DOF.getRotationalLimitMotor(2);
		...
		/// ******* RIGHT HIP ******** ///
		{
			...
			//joint6DOF->setAngularUpperLimit(btVector3(SIMD_EPSILON,SIMD_EPSILON,SIMD_EPSILON));
			//#else
			tmp.set(-BulletGlobals.SIMD_HALF_PI, -BulletGlobals.SIMD_EPSILON, -BulletGlobals.SIMD_HALF_PI * 0.6f);
			joint6DOF.setAngularLowerLimit(tmp);
			...
			joints[JointType.JOINT_RIGHT_HIP.ordinal()] = joint6DOF;
                        ...
                        motors[21] = joint6DOF.getRotationalLimitMotor(0);
                        motors[22] = joint6DOF.getRotationalLimitMotor(1);
                        motors[23] = joint6DOF.getRotationalLimitMotor(2);
		...
		/// ******* LEFT KNEE ******** ///
		{
			...
			joints[JointType.JOINT_LEFT_KNEE.ordinal()] = joint6DOF;
                        ...
                        motors[24] = joint6DOF.getRotationalLimitMotor(0);
                        motors[25] = joint6DOF.getRotationalLimitMotor(1);
                        motors[26] = joint6DOF.getRotationalLimitMotor(2);
		...
		/// ******* RIGHT KNEE ******** ///
		{
			...
			joints[JointType.JOINT_RIGHT_KNEE.ordinal()] = joint6DOF;
                        ...
                        motors[27] = joint6DOF.getRotationalLimitMotor(0);
                        motors[28] = joint6DOF.getRotationalLimitMotor(1);
                        motors[29] = joint6DOF.getRotationalLimitMotor(2);
