...
public class DynamicControlDemo extends DemoApplication {
	...
	public void clientMoveAndDisplay() {
		...
		for (int r=0; r<rigs.size(); r++) {
			for (int i=0; i<2*TestRig.NUM_LEGS; i++) {
				...
				float targetAngle = 0.5f * (1.0f + (float)Math.sin(i + r + BulletGlobals.SIMD_2_PI * targetPercent));
	...
	public static void main(String[] args) throws LWJGLException {
		...
		LWJGL.main(args, 1024, 768, "Bullet Physics Demo. http://bullet.sf.net", demoApp);
	}
